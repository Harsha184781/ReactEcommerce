...
// navbar component this component has icons imported from reacticons and i used module.css which i imported from separate file 
// we are getting data from store using useSelector from redux ,i used link for routing purpose
const Navbar = () => {
